...
CORRUPT_CONTENT_PATTERNS = [
    ...
    re.compile(r"[A-Za-z]{2,}[\u4e00-\u9fff][A-Za-z]{2,}"),
    re.compile(r"[\u4e00-\u9fff](?:s|ed|ing|led|ice)\b", re.IGNORECASE),
    re.compile(r"[\u4e00-\u9fff]\s+(?:a|an|as|by|in|on|or|to)\b"),
    re.compile(r"\b(?:Enter a|Run by|Try Claude|Following a|Computer use|Claude now has a)\b", re.IGNORECASE),
    re.compile(r"(?:\u6253\u5f00id|\u5173line|\u6253\u5f00AI|market\u4f4d\u7f6e)", re.IGNORECASE),
    re.compile(r"Claude://|claude://\S*[\u4e00-\u9fff]"),
    re.compile(r"Claude·|(?:\u8ba9\s*)?Claude\u505a\u996d|\u5f00\u59cb\u505a\u996d|\u5165\u4f4f|\u7403\u961f\u6539\u8fdb\s*Claude"),
    re.compile(r"\u5360\u9886\u5c4f\u5e55|\u6b64\u652f\u7968\u76ee\u524d|\sisn['’]t\s|\sthe\s+\u9879\u76ee|\u6253\u5f00\s+the\s+diff|\u65e0\u6cd5\s+\u53d6\u6d88\s+the\s+run"),
    re.compile(r"\u652f\u7968|\u795e\u5668"),
    re.compile(r"^\?{4,}$"),
]
